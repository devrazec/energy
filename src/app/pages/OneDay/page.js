...
export default function OneDayPage() {
    ...
    const chartOption = useMemo(() => {
        ...
        const forecastData = dbOneDay?.forecast ?? [];
    ...
    }, [dbOneDay, interval, mobileDevice, darkMode]);

    const summary = dbOneDay?.summary?.[interval] ?? {};

    const timestamps = Object.keys(dbOneDay?.measurements?.[interval] ?? {}).sort();
